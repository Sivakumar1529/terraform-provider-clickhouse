...
You can find more example on how to use this provider on [Github](https://github.com/smugantechamb/terraform-provider-clickhouse/tree/main/examples/full).
...
Please visit [https://github.com/smugantechamb/terraform-provider-clickhouse#breaking-changes-and-deprecations](https://github.com/smugantechamb/terraform-provider-clickhouse#breaking-changes-and-deprecations) for more details.
...
then a manual process is required after the upgrade. Please visit [https://github.com/smugantechamb/terraform-provider-clickhouse#breaking-changes-and-deprecations](https://github.com/smugantechamb/terraform-provider-clickhouse#breaking-changes-and-deprecations) for more details.
